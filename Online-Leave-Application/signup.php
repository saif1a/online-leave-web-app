...
error_reporting(E_ALL);
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">Online Leave Application</a>
  ...
  <div>
    <p class="text-center">&copy; <?php echo date("Y"); ?> - Online Internship Leave Application</p>
      <p class="text-center">Developed By Yahyaoui Saif Eddine</p>
    </div>
  </footer>
